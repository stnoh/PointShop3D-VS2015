...
class UTILITIES_API ANNkdStats {			// stats on kd-tree
public:
...
UTILITIES_API extern int	N_data_pts;	// number of data points
UTILITIES_API extern int	N_visit_lfs;	// number of leaf nodes visited
UTILITIES_API extern int	N_visit_spl;	// number of splitting nodes visited
UTILITIES_API extern int	N_visit_shr;	// number of shrinking nodes visited
UTILITIES_API extern int	N_visit_pts;	// visited points for one query
UTILITIES_API extern int	N_coord_hts;	// coordinate hits for one query
UTILITIES_API extern int	N_float_ops;	// floating ops for one query
UTILITIES_API extern SampStat	visit_lfs;	// stats on leaf nodes visits
UTILITIES_API extern SampStat	visit_spl;	// stats on splitting nodes visits
UTILITIES_API extern SampStat	visit_shr;	// stats on shrinking nodes visits
UTILITIES_API extern SampStat	visit_nds;	// stats on total nodes visits
UTILITIES_API extern SampStat	visit_pts;	// stats on points visited
UTILITIES_API extern SampStat	coord_hts;	// stats on coordinate hits
UTILITIES_API extern SampStat	float_ops;	// stats on floating ops
UTILITIES_API extern SampStat	average_err;	// average error
UTILITIES_API extern SampStat	rank_err;	// rank error

//----------------------------------------------------------------------
//  Declaration of externally accessible routines for statistics
//----------------------------------------------------------------------

UTILITIES_API void reset_stats(int data_size);	// reset stats for a set of queries

UTILITIES_API void reset_counts();			// reset counts for one queries

UTILITIES_API void update_stats();			// update stats with current counts

UTILITIES_API void print_stats(ANNbool validate);	// print statistics for a run
