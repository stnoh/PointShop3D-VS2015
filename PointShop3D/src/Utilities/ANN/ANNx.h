...
void UTILITIES_API annError(			// ANN error routine
    char		*msg,		// error message
    ANNerr		level);		// level of error

void UTILITIES_API annPrintPt(		// print a point
...
class UTILITIES_API ANNorthRect {
public:
...
void UTILITIES_API annAssignRect(		// assign one rect to another
...
class UTILITIES_API ANNorthHalfSpace {
public:
