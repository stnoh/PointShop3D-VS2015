...
#define ANNversion	"0.2"		// ANN version number
...
UTILITIES_API ANNdist annDist(
    int			dim,		// dimension of space
    ANNpoint		p,		// points
    ANNpoint		q);

UTILITIES_API ANNpoint annAllocPt(
    int			dim,		// dimension
    ANNcoord		c = 0);		// coordinate value (all equal)

UTILITIES_API ANNpointArray annAllocPts(
    int			n,		// number of points
    int			dim);		// dimension

UTILITIES_API void annDeallocPt(
    ANNpoint		&p);		// deallocate 1 point
   
UTILITIES_API void annDeallocPts(
    ANNpointArray	&pa);		// point array

UTILITIES_API ANNpoint annCopyPt(			// copy point
    int			dim,		// dimension
...
//----------------------------------------------------------------------
class UTILITIES_API ANNpointSet {
public:
...
class UTILITIES_API ANNbruteForce: public ANNpointSet {
    int			dim;		// dimension
...
class UTILITIES_API ANNkd_tree: public ANNpointSet {
protected:
    int			dim;		// dimension of space
...
class UTILITIES_API ANNbd_tree: public ANNkd_tree {
public:
...
UTILITIES_API void annMaxPtsVisit(			// limit max. pts to visit in search
