// Title:   GreyscalePlugin.h
// Created: Thu Sep 25 14:43:59 2003
...
#ifndef __GREYSCALEPLUGIN_H_
#define __GREYSCALEPLUGIN_H_
 ...
 * the <em>active</em> <code>Object</code> to greyscale.
 *
 * @author Oliver Knoll
 * @version 1.2
 */
class GreyscalePlugin : public PluginInterface {

public:
	
	PLUGIN_API GreyscalePlugin();
	PLUGIN_API virtual ~GreyscalePlugin();
